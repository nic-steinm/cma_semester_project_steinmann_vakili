...
subtitle: Using Computational Movement Analysis to protect crops and keep boars alive.
...
This agrees well with the months of data filtering.However, there are fields in which the wild boars ignored the wild boar fright and could not be driven away, despite acoustic deterrence. There are therefore outliers in the method of action.
